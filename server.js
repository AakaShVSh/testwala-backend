 ...
 *  - Redis client is initialised early (imported via App.js → configs/redis).
 *  - Graceful shutdown now also closes the Redis connection.
 *  - Everything else (Socket.io rooms, MongoDB connect) is unchanged.
 */
require("dotenv").config();
const http = require("http");
const { Server } = require("socket.io");
